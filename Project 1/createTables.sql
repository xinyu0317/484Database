...
CREATE TRIGGER PROGRAM_TRIGGER
    ...
    FOR EACH ROW
    BEGIN
        SELECT TRIGGER_SEQUENCE.NEXTVAL INTO :NEW.PROGRAM_ID FROM DUAL;
    END;
/
...
CREATE TRIGGER CITIES_TRIGGER
    ...
    FOR EACH ROW
    BEGIN
        SELECT TRIGGER_SEQUENCE.NEXTVAL INTO :NEW.CITY_ID FROM DUAL;
    END;
/
...
-- alter table for albums and photos
ALTER TABLE ALBUMS
ADD CONSTRAINT ALBUMS_CONSTRAINT
    FOREIGN KEY (COVER_PHOTO_ID) REFERENCES PHOTOS(PHOTO_ID)
INITIALLY DEFERRED DEFERRABLE;
SET CONSTRAINT ALBUMS_CONSTRAINT DEFERRED;

ALTER TABLE PHOTOS
ADD CONSTRAINT PHOTO_CONSTRAINT
    FOREIGN KEY (ALBUM_ID) REFERENCES ALBUMS(ALBUM_ID)
INITIALLY DEFERRED DEFERRABLE;
SET CONSTRAINT PHOTO_CONSTRAINT DEFERRED;
